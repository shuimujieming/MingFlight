...
int DR16_Signal = 0;
/**
 *@Function:		DR16_DataDecode
 *@Description:	DR16接收数据解码处理
 *@Param:       形参
 *@Return:	  	返回值
 */
...
/**
 *@Function:		USART_DR16_IRQHandler
 *@Description:	DR16串口中断处理函数
 *@Param:       形参
 *@Return:	  	返回值
 */
